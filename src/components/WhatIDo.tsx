        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building predictive models, exploring time-series data, and training
                deep learning algorithms for real-world environmental and business use cases.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing agentic RAG systems, building LLM-integrated applications,
                and creating scalable backend APIs for offline crisis tools.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
